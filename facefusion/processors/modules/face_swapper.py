...
MODEL_SET : ModelSet =\
{
	'blendswap_256':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/blendswap_256.hash',
				'path': resolve_relative_path('../.assets/models-opt21/blendswap_256.hash')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_w600k_r50.hash',
				'path': resolve_relative_path('../.assets/models-opt21/arcface_w600k_r50.hash')
			}
		},
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/blendswap_256.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/blendswap_256.onnx')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_w600k_r50.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/arcface_w600k_r50.onnx')
			}
		},
		'type': 'blendswap',
		'template': 'ffhq_512',
	...
	'ghost_256_unet_1':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/ghost_256_unet_1.hash',
				'path': resolve_relative_path('../.assets/models-opt21/ghost_256_unet_1.hash')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_ghost.hash',
				'path': resolve_relative_path('../.assets/models-opt21/arcface_ghost.hash')
			}
		},
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/ghost_256_unet_1.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/ghost_256_unet_1.onnx')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_ghost.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/arcface_ghost.onnx')
			}
		},
		'type': 'ghost',
	...
	'ghost_256_unet_2':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/ghost_256_unet_2.hash',
				'path': resolve_relative_path('../.assets/models-opt21/ghost_256_unet_2.hash')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_ghost.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/ghost_256_unet_2.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/ghost_256_unet_2.onnx')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_ghost.onnx',
	...
	'ghost_256_unet_3':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/ghost_256_unet_3.hash',
				'path': resolve_relative_path('../.assets/models-opt21/ghost_256_unet_3.hash')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_ghost.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/ghost_256_unet_3.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/ghost_256_unet_3.onnx')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_ghost.onnx',
	...
	'inswapper_128':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/inswapper_128.hash',
				'path': resolve_relative_path('../.assets/models-opt21/inswapper_128.hash')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21//arcface_w600k_r50.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/inswapper_128.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/inswapper_128.onnx')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_w600k_r50.onnx',
	...
	'inswapper_128_fp16':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/inswapper_128_fp16.hash',
				'path': resolve_relative_path('../.assets/models-opt21/inswapper_128_fp16.hash')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_w600k_r50.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/inswapper_128_fp16.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/inswapper_128_fp16.onnx')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_w600k_r50.onnx',
	...
	'simswap_256':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/simswap_256.hash',
				'path': resolve_relative_path('../.assets/models-opt21/simswap_256.hash')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_simswap.hash',
				'path': resolve_relative_path('../.assets/models-opt21/arcface_simswap.hash')
			}
		},
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/simswap_256.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/simswap_256.onnx')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_simswap.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/arcface_simswap.onnx')
			}
		},
		'type': 'simswap',
		'template': 'arcface_112_v1',
	...
	'simswap_512_unofficial':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/simswap_512_unofficial.hash',
				'path': resolve_relative_path('../.assets/models-opt21/simswap_512_unofficial.hash')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_simswap.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/simswap_512_unofficial.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/simswap_512_unofficial.onnx')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_simswap.onnx',
	...
	'uniface_256':
	{
		'hashes':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/uniface_256.hash',
				'path': resolve_relative_path('../.assets/models-opt21/uniface_256.hash')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_w600k_r50.hash',
		...
		'sources':
		{
			'face_swapper':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/uniface_256.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/uniface_256.onnx')
			},
			'face_recognizer':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/arcface_w600k_r50.onnx',
