...
MODEL_SET : ModelSet =\
{
	'gender_age':
	{
		'hashes':
		{
			'gender_age':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/gender_age.hash',
				'path': resolve_relative_path('../.assets/models-opt21/gender_age.hash')
			}
		},
		'sources':
		{
			'gender_age':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/gender_age.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/gender_age.onnx')
			}
		}
	}
}
