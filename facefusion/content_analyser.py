...
MODEL_SET : ModelSet =\
{
	'open_nsfw':
	{
		'hashes':
		{
			'content_analyser':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/open_nsfw.hash',
				'path': resolve_relative_path('../.assets/models-opt21/open_nsfw.hash')
			}
		},
		'sources':
		{
			'content_analyser':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/open_nsfw.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/open_nsfw.onnx')
			}
		}
	}
}
