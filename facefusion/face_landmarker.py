...
MODEL_SET : ModelSet =\
{
	'2dfan4':
	{
		'hashes':
		{
			'2dfan4':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/2dfan4.hash',
				'path': resolve_relative_path('../.assets/models-opt21/2dfan4.hash')
			}
		},
		'sources':
		{
			'2dfan4':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/2dfan4.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/2dfan4.onnx')
			}
		}
	},
	'peppa_wutz':
	{
		'hashes':
		{
			'peppa_wutz':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/peppa_wutz.hash',
				'path': resolve_relative_path('../.assets/models-opt21/peppa_wutz.hash')
			}
		},
		'sources':
		{
			'peppa_wutz':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/peppa_wutz.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/peppa_wutz.onnx')
			}
		}
	},
	'face_landmarker_68_5':
	{
		'hashes':
		{
			'face_landmarker_68_5':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/face_landmarker_68_5.hash',
				'path': resolve_relative_path('../.assets/models-opt21/face_landmarker_68_5.hash')
			}
		},
		'sources':
		{
			'face_landmarker_68_5':
			{
				'url': 'https://github.com/facefusion/facefusion-assets/releases/download/models-3.0.0-opt21/face_landmarker_68_5.onnx',
				'path': resolve_relative_path('../.assets/models-opt21/face_landmarker_68_5.onnx')
			}
		}
	}
}
